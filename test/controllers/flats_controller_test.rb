...
class FlatsControllerTest < ActionController::TestCase
  ...
  test "should create flat" do
    assert_difference('Flat.count') do
      post :create, flat: { Address: @flat.Address, Name: @flat.Name, Occupied: @flat.Occupied, RentalDate: @flat.RentalDate }
    end
  ...
  test "should update flat" do
    patch :update, id: @flat, flat: { Address: @flat.Address, Name: @flat.Name, Occupied: @flat.Occupied, RentalDate: @flat.RentalDate }
    assert_redirected_to flat_path(assigns(:flat))
  end
